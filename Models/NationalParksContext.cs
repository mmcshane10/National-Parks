        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<Park>()
                .HasData(
                    ...
                    new Park { ParkId = 10, Name = "Gateway Arch", Description = "The Gateway Arch is a 630-foot (192 m) (both high and wide) catenary arch built to commemorate the Lewis and Clark Expedition, initiated by Thomas Jefferson, and the subsequent westward expansion of the country.", Established = "February 22, 2018", States = "Missouri", Size = "192.83 acres", Visitors = ",016,180", ImageURL = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/St_Louis_night_expblend.jpg/200px-St_Louis_night_expblend.jpg" }
